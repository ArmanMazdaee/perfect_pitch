...
class OnsetsDetector(torch.nn.Module):
    def __init__(self):
        ...
        self.conv2d_stack = torch.nn.Sequential(
            ...
            _Conv2dResidualBlock(in_channels=8, out_channels=16, dilation=4),
            ...
            _Conv2dResidualBlock(in_channels=32, out_channels=64, dilation=64),
            _Conv2dResidualBlock(in_channels=64, out_channels=64, dilation=128),
        )
        self.linear_stack = torch.nn.Sequential(
            torch.nn.Conv1d(
                in_channels=num_pitches * 64, out_channels=256, kernel_size=1,
            ),
            torch.nn.ReLU(),
